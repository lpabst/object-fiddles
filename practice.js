...
//After you've made your object, add another key named 'car' with the value being your favorite car and then another key named 'brand' with the value being your favorite brand.
  ...
  //Code here
favoriteThings.car = 'Veneno';
favoriteThings.brand = 'Lamborghini';
...
//Create an Object called 'album' with 5 keys named different song titles that you make up, with the values being the length of each song.
  ...
  var album = {
    ...
    titleTwo: '2 min',
    titleThree: '4 min',
    titleFour: '4 min 30 sec',
    titleFive: '3 min 20 sec'
  }
...
//Once you get your truthy Object, Change the remaining values in the object to be specific to you (name: 'your name', username: 'your username'), rather than my information.
  ...
  //Code Here
user1.name = "Loren";
user1.pwHash = 'lkjwerh';
user1.username = 'lpabst';
...
//object and returns that object so that whenever you invoke makeCard, you get a brand new credit card.
  ...
  //Code Here
function makeCard(number, expirationDate, securityCode){
  var creditcard = {
    cardNumber: number,
